...
def system_of_equations(T_i0,M,N,q_dot,alpha,h,T_inf,K,delta_t,i):
    ...
    for m in range(M+1):
        for n in range(N+1):
            ...
            if knot.group == 1.1:
                ...
                print(T_i0[m][n])
                b[k] = - q_dot*knot.delta_x/K - knot.delta_x*knot.delta_y*T_i0[m][n]/(2*alpha*delta_t)
            
            elif knot.group == 1.2:
                A[k][k] = - knot.delta_x/knot.delta_y - knot.delta_y/knot.delta_x - knot.delta_x*knot.delta_y/(2*alpha*delta_t)
                A[k][k+(N+1)] = knot.delta_y/knot.delta_x
                A[k][k-1] = knot.delta_x/knot.delta_y
                b[k] = - knot.delta_x*knot.delta_y*T_i0[m][n]/(2*alpha*delta_t)
                ...
                A[k][k-1] = knot.delta_x/knot.delta_y
                A[k][k+1] = knot.delta_x/knot.delta_y
                b[k] = - knot.delta_x*knot.delta_y*T_i0[m][n]/(alpha*delta_t)
                ...
                A[k][k+-1] = knot.delta_y/knot.delta_x
                A[k][k+1] = knot.delta_x/knot.delta_y
                b[k] = - 2*q_dot*knot.delta_x/K - knot.delta_x*knot.delta_y*T_i0[m][n]/(alpha*delta_t)
                ...
                b[k] = (- h*(knot.delta_y_b + knot.delta_x_b)*T_inf/K - T_i0[m][n]*(knot.delta_x_a*(knot.delta_y_b + knot.delta_y_a) + 
                ...
                A[k][k-1] = knot.delta_x_a/knot.delta_y_b
                b[k] = (- h*(knot.delta_y_b + knot.delta_x_b)*T_inf/K - T_i0[m][n]*(knot.delta_x_a*(knot.delta_y_b + knot.delta_y_c) + 
                ...
                A[k][k-(N+1)] = knot.delta_y/knot.delta_x
                A[k][k-1] = knot.delta_x/knot.delta_y
                b[k] = - h*knot.delta_x*T_inf/K - knot.delta_x*knot.delta_y*T_i0[m][n]/(2*alpha*delta_t)
                k_q_dot_array.append(k)
                ...
                A[k][k-1] = knot.delta_x/knot.delta_y
                A[k][k+1] = knot.delta_x/knot.delta_y
                b[k] = - 2*h*knot.delta_y*T_inf/K - knot.delta_x*knot.delta_y*T_i0[m][n]/(alpha*delta_t)
                k_q_dot_array.append(k)
                ...
                A[k][k+(N+1)] = knot.delta_y/knot.delta_x
                A[k][k-1] = 2*knot.delta_x/knot.delta_y
                b[k] = -2*h*knot.delta_x*T_inf/K - knot.delta_x*knot.delta_y*T_i0[m][n]/(alpha*delta_t)
                k_q_dot_array.append(k)

    ...
    for m in range(M+1):
        ...
        for n in range(N+1):
            ...
            if knot.group == 1.1:
                ...
                A[k][k+1] = 2*knot.delta_y/knot.delta_x
                A[k][k+(N+1)] = knot.delta_x/knot.delta_y
                A[k][k-(N+1)] = knot.delta_x/knot.delta_y
                ...
                A[k][k-1] = knot.delta_y/knot.delta_x
                A[k][k+1] = knot.delta_y/knot.delta_x
                A[k][k+(N+1)] = 2*knot.delta_x/knot.delta_y
                b[k] = - knot.delta_x*knot.delta_y*T[i-1][m][n]/(alpha*delta_t)
                ...
                A[k][k-1] = (knot.delta_y_b + knot.delta_y_a)/knot.delta_x_a
                A[k][k+1] = knot.delta_y_a/knot.delta_x_b
                A[k][k-(N+1)] = knot.delta_x_a/knot.delta_y_b
                A[k][k+(N+1)] = (knot.delta_x_b + knot.delta_x_a)/knot.delta_y_a
                ...
                A[k][k-1] = (knot.delta_y_c + knot.delta_y_b)/knot.delta_x_a
                A[k][k+1] = knot.delta_y_c/knot.delta_x_b
                A[k][k-(N+1)] = (knot.delta_x_a + knot.delta_x_b)/knot.delta_y_c
                A[k][k+(N+1)] = knot.delta_x_a/knot.delta_y_b
